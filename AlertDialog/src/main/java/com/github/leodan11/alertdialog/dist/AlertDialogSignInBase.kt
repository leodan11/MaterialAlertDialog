...
abstract class AlertDialogSignInBase(
    ...
    abstract class Builder<D : AlertDialogSignInBase>(protected open val context: Context) :
         ...
         *
         * @param onClickListener    The [MaterialAlert.OnClickSignInListener] to use.
         *
         * @return [Builder] object to allow for chaining of calls to set methods
         *
         */
        fun setPositiveButton(onClickListener: MaterialAlert.OnClickSignInListener): Builder<D> {
        ...
        fun setPositiveButton(
            icon: ButtonIconAlert,
            onClickListener: MaterialAlert.OnClickSignInListener
        ): Builder<D> {
