...
abstract class SettingsComponentBase(
     ...
     *
     */
    abstract class Builder<D : SettingsComponentBase>(protected val context: Context) :
        AlertBuilder() {
